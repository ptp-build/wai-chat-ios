...
protocol VideoRecordViewControllerDelegate{
    func setVideoRecordResult(message : String)
}

class VideoRecordViewController: BaseController,AVCaptureFileOutputRecordingDelegate {
    var delegateCb : VideoRecordViewControllerDelegate?
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationItem.title = "录制视频"
//        self.delegateCb?.setVideoRecordResult(message:"test")
    }
